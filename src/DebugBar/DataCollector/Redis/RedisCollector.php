...
class RedisCollector extends DataCollector implements Renderable, AssetProvider
{
     ...
     */
    public function __construct(BaseTraceableRedis $redis = null, TimeDataCollector $timeCollector = null)
    {
     ...
     *
     * @param TraceableRedis $redis
     * @param string $name Optional connection name
     */
    public function addConnection(BaseTraceableRedis $redis, $name = null)
    {
        if ($name === null) {
     ...
     *
     * @param BaseTraceableRedis $redis
     * @param TimeDataCollector $timeCollector
     * @return array
     */
    protected function collectRedis(BaseTraceableRedis $redis, TimeDataCollector $timeCollector = null)
    {
        $stmts = array();
